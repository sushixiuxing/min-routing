...
#ifndef MIN_ROUTING_HEADER_H
#define MIN_ROUTING_HEADER_H
 ...
 * \ingroup min_routing
 *
 * The basic layout of any packet in Min_Routing is as follows (omitting IP and
 * UDP headers):
  \verbatim
    0                   1                   2                   3
...
public:
  ...
  */
  ...
  \verbatim
   ...
   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
   |          x_pos                |     Htime     |  Willingness  |       //remove Reserved,add x_pos
   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
   |          y_pos                |     x_vel     |     y_vel     |       //add y_pos and x_vol ,y_vol
   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  ...
  */
  struct Hello
  {
    ...
    uint16_t x_pos;            // add,the location of the x lable of the node
    ...
    uint16_t y_pos;            //add,the location of the y lable of the node

    uint8_t x_vel;          //add,the  x velocity of the node

    uint8_t y_vel;          //add,the y velocity of the node
