...
MprSelectorTuple*
Min_routingState::FindMprSelectorTuple (Ipv4Address const &mainAddr)
{
...
void
Min_routingState::EraseMprSelectorTuple (const MprSelectorTuple &tuple)
{
  for (MprSelectorSet::iterator it = m_mprSelectorSet.begin ();
       it != m_mprSelectorSet.end (); it++)
    {
...
void
Min_routingState::EraseMprSelectorTuples (const Ipv4Address &mainAddr)
{
  for (MprSelectorSet::iterator it = m_mprSelectorSet.begin ();
...
void
Min_routingState::InsertMprSelectorTuple (MprSelectorTuple const &tuple)
{
  m_mprSelectorSet.push_back (tuple);
}

std::string
Min_routingState::PrintMprSelectorSet () const
{
...
NeighborTuple*
Min_routingState::FindNeighborTuple (Ipv4Address const &mainAddr)
{
...
const NeighborTuple*
Min_routingState::FindSymNeighborTuple (Ipv4Address const &mainAddr) const
{
...
NeighborTuple*
Min_routingState::FindNeighborTuple (Ipv4Address const &mainAddr, uint8_t willingness)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
Min_routingState::EraseNeighborTuple (const NeighborTuple &tuple)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
Min_routingState::EraseNeighborTuple (const Ipv4Address &mainAddr)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
Min_routingState::InsertNeighborTuple (NeighborTuple const &tuple)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
TwoHopNeighborTuple*
Min_routingState::FindTwoHopNeighborTuple (Ipv4Address const &neighborMainAddr,
...
void
Min_routingState::EraseTwoHopNeighborTuple (const TwoHopNeighborTuple &tuple)
{
  for (TwoHopNeighborSet::iterator it = m_twoHopNeighborSet.begin ();
       it != m_twoHopNeighborSet.end (); it++)
    {
...
void
Min_routingState::EraseTwoHopNeighborTuples (const Ipv4Address &neighborMainAddr,
...
void
Min_routingState::InsertTwoHopNeighborTuple (TwoHopNeighborTuple const &tuple)
{
...
bool
Min_routingState::FindMprAddress (Ipv4Address const &addr)
{
...
void
Min_routingState::SetMprSet (MprSet mprSet)
{
  m_mprSet = mprSet;
}
MprSet
Min_routingState::GetMprSet () const
{
  return m_mprSet;
}
...
DuplicateTuple*
Min_routingState::FindDuplicateTuple (Ipv4Address const &addr, uint16_t sequenceNumber)
{
...
void
Min_routingState::EraseDuplicateTuple (const DuplicateTuple &tuple)
{
  for (DuplicateSet::iterator it = m_duplicateSet.begin ();
       it != m_duplicateSet.end (); it++)
    {
...
void
Min_routingState::InsertDuplicateTuple (DuplicateTuple const &tuple)
{
...
LinkTuple*
Min_routingState::FindLinkTuple (Ipv4Address const & ifaceAddr)
{
...
LinkTuple*
Min_routingState::FindSymLinkTuple (Ipv4Address const &ifaceAddr, Time now)
{
  for (LinkSet::iterator it = m_linkSet.begin ();
       it != m_linkSet.end (); it++)
    {
...
void
Min_routingState::EraseLinkTuple (const LinkTuple &tuple)
{
  for (LinkSet::iterator it = m_linkSet.begin ();
       it != m_linkSet.end (); it++)
    {
...
LinkTuple&
Min_routingState::InsertLinkTuple (LinkTuple const &tuple)
{
...
TopologyTuple*
Min_routingState::FindTopologyTuple (Ipv4Address const &destAddr,
...
TopologyTuple*
Min_routingState::FindNewerTopologyTuple (Ipv4Address const & lastAddr, uint16_t ansn)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
       it != m_topologySet.end (); it++)
    {
...
void
Min_routingState::EraseTopologyTuple (const TopologyTuple &tuple)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
       it != m_topologySet.end (); it++)
    {
...
void
Min_routingState::EraseOlderTopologyTuples (const Ipv4Address &lastAddr, uint16_t ansn)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
...
void
Min_routingState::InsertTopologyTuple (TopologyTuple const &tuple)
{
...
IfaceAssocTuple*
Min_routingState::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr)
{
...
Min_routingState::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr) const
{
...
void
Min_routingState::EraseIfaceAssocTuple (const IfaceAssocTuple &tuple)
{
  for (IfaceAssocSet::iterator it = m_ifaceAssocSet.begin ();
       it != m_ifaceAssocSet.end (); it++)
    {
...
void
Min_routingState::InsertIfaceAssocTuple (const IfaceAssocTuple &tuple)
{
  m_ifaceAssocSet.push_back (tuple);
}

std::vector<Ipv4Address>
Min_routingState::FindNeighborInterfaces (const Ipv4Address &neighborMainAddr) const
{
...
AssociationTuple*
Min_routingState::FindAssociationTuple (const Ipv4Address &gatewayAddr, const Ipv4Address &networkAddr, const Ipv4Mask &netmask)
{
...
void
Min_routingState::EraseAssociationTuple (const AssociationTuple &tuple)
{
  for (AssociationSet::iterator it = m_associationSet.begin ();
       it != m_associationSet.end (); it++)
    {
...
void
Min_routingState::InsertAssociationTuple (const AssociationTuple &tuple)
{
  m_associationSet.push_back (tuple);
}

void
Min_routingState::EraseAssociation (const Association &tuple)
{
...
void
Min_routingState::InsertAssociation (const Association &tuple)
{
  m_associations.push_back (tuple);
}

}
}  // namespace min_routing, ns3
