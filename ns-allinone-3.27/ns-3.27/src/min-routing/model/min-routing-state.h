...
#ifndef MIN_ROUTING_STATE_H
#define MIN_ROUTING_STATE_H
...
/// \ingroup min_routing
/// This class encapsulates all data structures needed for maintaining internal state of an Min_Routing node.
class Min_routingState
{
  //  friend class Min_routing;
