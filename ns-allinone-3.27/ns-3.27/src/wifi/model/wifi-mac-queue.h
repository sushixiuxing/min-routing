...
public:
   ...
   */
   ...
   Time GettotalWaitingtime(void);    // I add!  To return the waiting of the packet
   uint32_t Gettotalpackets(void);         //I add! To return the total number of the packets
...
private:
  ...
  bool TtlExceeded (ConstIterator &it);
   ...
   Time m_totalwaitingtime;          //I add! the waiting time of a packet
   uint32_t m_totalpackets;                //I add! the total packets which be dequeued
